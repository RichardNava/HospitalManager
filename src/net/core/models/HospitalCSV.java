...
public final class HospitalCSV implements Comparable<HospitalCSV> {
    ...
    public HospitalCSV(LocalDate fecha, Unidad unidad, String provincia, int camas) {
        this.fecha = fecha;
        this.unidad = unidad;
    ...
    public HospitalCSV(String fecha, String unidad, String provincia, int camas) {
        setFecha(fecha);
        setUnidad(unidad);
        this.provincia = provincia;
        this.camas = camas;
    ...
    @Override
    public int compareTo(HospitalCSV t) {
